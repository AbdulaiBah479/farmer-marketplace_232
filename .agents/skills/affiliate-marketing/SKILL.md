...
<<<<<<< HEAD
description: "Building and managing affiliate programs: recruitment, tracking, commission structures, and compliance."
category: marketing
=======
...
<<<<<<< HEAD
Building and managing affiliate programs: recruitment, tracking, commission structures, and compliance.

## When to Use
Use this skill when working on tasks related to affiliate marketing.

## Key Capabilities
- Expert guidance on affiliate marketing workflows and best practices
- Step-by-step assistance for common affiliate marketing tasks
