...
| `<URL_FUNCTIONAL_DETAIL_DOC>` | `<URL_DOC_DETALLE_FUNCIONAL>` | URL to functional detail doc | Architecture docs do not typically contain this | `NOT FOUND — suggest: add functional spec URL to docs/11-references.md` |
| `<URL_CAPABILITY_MAP>` | `<URL_MAPA_CAPACIDADES>` | URL to capability map | Architecture docs do not typically contain this | `NOT FOUND — suggest: add capability map URL to docs/11-references.md` |
| `<URL_TARGET_VALUE_FLOW>` | `<URL_FLUJO_VALOR_OBJETIVO>` | URL to value flow diagram | Architecture docs do not typically contain this | `NOT FOUND — suggest: add value flow URL to docs/11-references.md` |
...
⚠️  NOT FOUND (N) — requires manual input:
   ...
   - All URLs → suggest: add to docs/11-references.md
   ...
═══════════════════════════════════════════════════════════
```
