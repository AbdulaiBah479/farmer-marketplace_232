...
**Orchestration Platform**: [Value or "Not specified"]
- Status: [Compliant/Non-Compliant/Not Applicable/Unknown]
- Explanation: [If Compliant: Orchestration platform identified (Airflow, Dagster, Prefect, Luigi, Argo Workflows, Step Functions, Cloud Composer, etc.). If Non-Compliant: Multi-step pipelines without orchestration platform, or cron-only scheduling for production. If Not Applicable: No data pipelines (transactional system only). If Unknown: Orchestration mentioned but platform not named]
- Source: [ARCHITECTURE.md Section X.Y or "Not documented"]
- Note: [If Non-Compliant or Unknown: Identify orchestration platform and document deployment topology in Section 6]

**Job Scheduling and Dependencies**: [Value or "Not specified"]
- Status: [Compliant/Non-Compliant/Not Applicable/Unknown]
- Explanation: [If Compliant: Job schedules and inter-job dependencies (DAGs) documented. If Non-Compliant: Schedules or dependencies undocumented. If Not Applicable: N/A. If Unknown: Scheduling mentioned but dependency graph unclear]
- Source: [ARCHITECTURE.md Section X.Y or "Not documented"]
- Note: [If Non-Compliant or Unknown: Document DAG topology, trigger conditions, and upstream/downstream dependencies in Section 6]

**Retry and SLA Policy**: [Value or "Not specified"]
- Status: [Compliant/Non-Compliant/Not Applicable/Unknown]
- Explanation: [If Compliant: Retry policy, failure handling, and per-pipeline SLAs documented. If Non-Compliant: No retry or SLA policy. If Not Applicable: N/A. If Unknown: Retries mentioned but policy unclear]
- Source: [ARCHITECTURE.md Section X.Y or "Not documented"]
- Note: [If Non-Compliant or Unknown: Define retry counts/backoff, failure escalation, and per-pipeline SLAs in Section 6 or 10]
...
### 8.5 Project Data Catalog

**Catalog Tooling**: [Value or "Not specified"]
- Status: [Compliant/Non-Compliant/Not Applicable/Unknown]
- Explanation: [If Compliant: Data catalog tooling identified (DataHub, Amundsen, Collibra, Alation, Glue Data Catalog, Unity Catalog, etc.). If Non-Compliant: Multiple data products without a catalog. If Not Applicable: Single-dataset application or no analytical/shared-data use case. If Unknown: Catalog mentioned but tool not named]
- Source: [ARCHITECTURE.md Section X.Y or "Not documented"]
- Note: [If Non-Compliant or Unknown: Select and document a data catalog platform, distinct from 8.4 institutional catalog compliance, in Section 8]

**Catalog Coverage**: [Value or "Not specified"]
- Status: [Compliant/Non-Compliant/Not Applicable/Unknown]
- Explanation: [If Compliant: Catalogued datasets enumerated with schema, owner, and discovery path. If Non-Compliant: Catalog exists but coverage scope undefined. If Not Applicable: N/A. If Unknown: Coverage mentioned but not scoped]
- Source: [ARCHITECTURE.md Section X.Y or "Not documented"]
- Note: [If Non-Compliant or Unknown: Document which datasets are catalogued (and which are intentionally excluded) in Section 8]

**Catalog Ownership and Maintenance**: [Value or "Not specified"]
- Status: [Compliant/Non-Compliant/Not Applicable/Unknown]
- Explanation: [If Compliant: Catalog steward, update cadence, and quality SLAs documented. If Non-Compliant: No ownership or maintenance process. If Not Applicable: N/A. If Unknown: Ownership mentioned but cadence unclear]
- Source: [ARCHITECTURE.md Section X.Y or "Not documented"]
- Note: [If Non-Compliant or Unknown: Assign catalog steward and define entry-freshness SLA in Section 8 or 12 (ADRs)]
