...
| Section 8 Missing | Not found or <50 characters | Skip EOL validation entirely | FAIL (critical data missing) |
| Partial Section 8 | Missing versions/details | Mark items UNKNOWN | FAIL if score < 5.0 |
| EOL or Near-EOL Versions | endoflife.date lookup vs today | Mark as FAIL | FAIL until upgrade/exception |
