...
> See ARCHITECTURE_DOCUMENTATION_GUIDE.md for the full S1-S13 → file path canonical mapping.
...
See [adr/README.md](adr/README.md) for ADR process · [References](docs/11-references.md)
```
