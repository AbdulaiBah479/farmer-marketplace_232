...
name: growth-hacking
<<<<<<< HEAD
description: "Growth hacking strategies: viral loops, referral programs, product-led growth, and retention mechanics."
category: marketing
---

# Growth Hacking

Growth hacking strategies: viral loops, referral programs, product-led growth, and retention mechanics.

## When to Use
Use this skill when working on tasks related to growth hacking.

## Key Capabilities
- Expert guidance on growth hacking workflows and best practices
- Step-by-step assistance for common growth hacking tasks
