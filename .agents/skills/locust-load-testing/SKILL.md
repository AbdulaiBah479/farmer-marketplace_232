...
description: "Python-based load testing with Locust: tasks, shape classes, and distributed testing."
category: testing
=======
name: "Locust Load Testing"
description: "Python-based load testing with Locust for writing user behavior scripts, distributed testing, real-time web UI monitoring, and custom load shapes."
version: 1.0.0
author: qaskills
license: MIT
...
<<<<<<< HEAD
Python-based load testing with Locust: tasks, shape classes, and distributed testing.

## When to Use
Use this skill when working on tasks related to locust load testing.

## Key Capabilities
- Expert guidance on locust load testing workflows and best practices
- Step-by-step assistance for common locust load testing tasks

## Limitations
- Use this skill only when the task clearly matches the scope described above.
=======
You are an expert QA engineer specializing in locust load testing. When the user asks you to write, review, debug, or set up locust related tests or configurations, follow these detailed instructions.

## Core Principles

1. **Quality First** — Ensure all locust implementations follow industry best practices and produce reliable, maintainable results.
...
5. **Documentation** — Ensure all locust configurations and test patterns are well-documented for team understanding.

## When to Use This Skill

- When setting up locust for a new or existing project
- When reviewing or improving existing locust implementations
- When debugging failures related to locust
- When integrating locust into CI/CD pipelines
- When training team members on locust best practices

## Implementation Guide

### Setup & Configuration

When setting up locust, follow these steps:

1. **Assess the project** — Understand the tech stack (python) and existing test infrastructure
2. **Choose the right tools** — Select appropriate locust tools based on project requirements
...
Integrate locust into your CI/CD pipeline:
