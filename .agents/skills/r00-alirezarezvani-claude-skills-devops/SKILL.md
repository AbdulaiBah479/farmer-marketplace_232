---
name: "r00-alirezarezvani-claude-skills--devops"
description: >
  ☁️ DevOps & Cloud Infrastructure skill suite derived from alirezarezvani/claude-skills.
...
```bash
# Install this skill
cp -r . ~/.claude/skills/r00-alirezarezvani-claude-skills--devops/

# In Claude Code
/read ~/.claude/skills/r00-alirezarezvani-claude-skills--devops/SKILL.md
```
