...
name: wcag-guide
description: >
  WCAG 2.2 reference and learning guide. Use this skill whenever the user asks
  about WCAG success criteria, conformance levels, what changed between WCAG
  versions, whether a specific criterion applies, or needs plain-language
  explanations of accessibility standards. Also trigger when the user mentions
  WCAG by number (e.g., "1.4.3", "2.4.11", "3.3.8"), asks about Level A vs AA
  vs AAA, asks what's new in WCAG 2.2, asks about POUR principles, or needs to
  understand compliance requirements. This skill teaches the standard — it does
  not write or review code.
---
...
- Write or review code (use the a11y-code-review skill for that)
- Run tests (use a testing guidance skill for that)
...
For code-level contrast checking, use the a11y-code-review skill.
```
